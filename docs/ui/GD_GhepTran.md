...
### 5.1. Desktop
- Layout dọc, trung tâm
- Bộ đếm thời gian lớn, nổi bật
- Danh sách người chơi hiển thị dưới dạng lưới hoặc hàng ngang

### 5.2. Tablet
- Layout tương tự desktop nhưng thu nhỏ
- Danh sách người chơi có thể xếp dọc

### 5.3. Mobile
- Layout full width với padding
- Bộ đếm thời gian ở trên
- Danh sách người chơi xếp dọc
- Nút "Hủy ghép trận" sticky ở bottom
- Dialog xác nhận full width
