...
### 5.1. Desktop
- Top 3 và Danh sách có thể hiển thị song song hoặc Top 3 nằm trên với kích thước lớn.

### 5.2. Mobile
- Sticky Bottom Bar luốn hiển thị.
- Top 3 thu gọn kích thước để dành chỗ cho danh sách.
