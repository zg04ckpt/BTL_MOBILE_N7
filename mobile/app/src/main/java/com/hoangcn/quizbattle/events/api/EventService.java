...
public class EventService extends BaseApi {
    ...
    public void updateQuizMilestoneProgress(UpdateQuizMilestoneProgressRequest requestBody, ApiCallback<EventProgressModel> callback) {
        var request = this.api.updateQuizMilestoneProgress(requestBody);
        enqueue(request, callback);
    }
}
