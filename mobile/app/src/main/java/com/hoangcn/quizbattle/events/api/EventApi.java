...
public interface EventApi {
    ...
    @PATCH("events/my-progresses/quiz-milestone")
    Call<ApiResponse<EventProgressModel>> updateQuizMilestoneProgress(@Body UpdateQuizMilestoneProgressRequest request);
}
